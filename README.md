...
is accepted, including `Revert "..." (#123)` subjects from revert PRs.
...
Allowed exceptions:
- Actual merge commits generated by Git
...
This writes both hooks into Git's configured hooks directory as lightweight,
worktree-safe wrappers. Each wrapper resolves the current worktree root at
runtime, then runs:
