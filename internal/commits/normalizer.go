...
// cleanSubject normalizes the subject text. Capitalization is a hard error,
// not a fix (handled in parseHeader); here we only trim surrounding whitespace
// and remove a trailing period.
