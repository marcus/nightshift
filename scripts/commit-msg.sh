...
# Capture the normalizer's stderr in a private, unpredictable temp file so
# concurrent commits cannot collide.
ERR_FILE="$(mktemp -t nightshift-commit-msg.err.XXXXXX)"
